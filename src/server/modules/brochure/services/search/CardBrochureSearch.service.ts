...
export class CardBrochureSearchService {
  public static readonly BROCHURE_CARD_FIELDS = [
    'brochure.id', 'brochure.title', 'brochure.url',
    'brochure.createdAt', 'brochure.updatedAt', 'brochure.parameterizedName',
    'brochure.validFrom', 'brochure.validTo',
    'brochure.nsfw', 'brochure.totalPages',
    'brand.id', 'brand.name', 'brand.parameterizedName',
    'brand.websiteId', 'brandLogo.version', 'brandAttachment.file',
  ...
  createCardsQuery(
    ...
    return (
      query
        ...
        .innerJoin('brand.website', 'website')
