...
export class BookReviewEntity extends RemoteRecordFields {
  ...
  initialConstantStats: VotingStatsEmbeddable; // stats fetched from remote website
  ...
  @BeforeUpdate()
  transformFields() {
    const {description, rating, initialConstantStats} = this;
    ...
    if (initialConstantStats)
      this.stats = initialConstantStats;
  }
}
