...
export class UpdateScrapperKindEnum1609682684432 implements MigrationInterface {
  name = 'UpdateScrapperKindEnum1609682684432';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TYPE "scrapper_metadata_kind_enum" AS ENUM('1', '2', '3')`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`COMMENT ON COLUMN "scrapper_metadata"."kind" IS NULL`);
    await queryRunner.query(`CREATE TYPE "scrapper_metadata_kind_enum_old" AS ENUM('1', '2')`);
    await queryRunner.query(`ALTER TABLE "scrapper_metadata" ALTER COLUMN "kind" DROP DEFAULT`);
